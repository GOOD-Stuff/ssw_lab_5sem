...
private:
    ...
    int   expressionParse            (lex_it &t_iter, SyntaxNode* parent);
    int   bracketsExpressionParse    (lex_it &t_iter);
    int   stateParse                 (lex_it &t_iter, SyntaxNode* parent);
    int   compoundParse              (lex_it &t_iter, SyntaxNode* parent);
    int   vardpParse                 (lex_it &t_iter);
    std::list<std::string> vardParse (lex_it &t_iter);
    int   blockParse                 (lex_it &t_iter, SyntaxNode* parent);
